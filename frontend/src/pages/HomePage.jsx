  ...
  return (
    <div className="landing-page" id="top">
      ...
      <section className="landing-hero">
        <img className="landing-hero-photo" src="/images/repair-workbench.jpg" alt="Technician repairing a laptop on a workbench." fetchPriority="high" />
